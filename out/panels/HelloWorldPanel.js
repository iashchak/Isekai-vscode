...
class HelloWorldPanel {
    ...
    static render(extensionUri, data) {
        if (HelloWorldPanel.currentPanel) {
            ...
            HelloWorldPanel.currentPanel._panel.reveal(vscode_1.ViewColumn.Beside);
        }
        else {
            ...
            // Panel title
            "Hello World", 
            // Open beside the currently active editor
        ...
        HelloWorldPanel.currentPanel._panel.webview.postMessage({ command: "update", data });
    }
    /**
